...
from output import print_positions, export_csv, export_svg, export_svg_for_footprints, export_svg_switch_plate, export_svg_mounting_holes
...
def main():
    ...
    print(f"- Thumb arc: {config.thumb_arc_config.start_angle}° to {config.thumb_arc_config.end_angle}° (radius: {config.thumb_arc_config.radius}mm)")
    print(f"- Thumb offset: ({config.thumb_arc_config.offset_x}mm, {config.thumb_arc_config.offset_y}mm)")
